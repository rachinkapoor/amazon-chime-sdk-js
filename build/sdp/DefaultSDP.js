...
class DefaultSDP {
    ...
    removeH264SupportFromSendSection() {
        ...
        let payloadTypesForH264 = [];
        let primaryPayloadTypeToFeedbackPayloadTypes = new Map();
            ...
            if (/^a=fmtp:/.test(attribute)) {
                ...
                if (feedbackMatches && feedbackMatches.length === 3) {
                    ...
                    if (primaryPayloadTypeToFeedbackPayloadTypes.has(primaryPayloadType)) {
                        (_a = primaryPayloadTypeToFeedbackPayloadTypes.get(primaryPayloadType)) === null || _a === void 0 ? void 0 : _a.push(feedbackPayloadType);
                    }
                    else {
